export default {
      ...
      listArr1: [
        {
          ...
          description: 'Uma plataforma de compartilhamento de vídeo curto, onde o conteúdo cria valor e tanto a atualização quanto a publicação de vídeo podem ser lucrativas.'
        },
        {
          imgUrl: require('../../assets/img/communityEcosystem/market_02.svg'),
          title: 'Loja Zhanshi',
          description: 'Uma plataforma de desconto de compras onde os usuários podem participar de atividades de desconto para todos os tipos de produtos e podem obter HashRate e descontos no consumo ao fazer pedidos.'
        },
        {
          imgUrl: require('../../assets/img/communityEcosystem/strange_03.svg'),
          title: 'Loja Motui',
          description: 'Uma plataforma de app de comércio eletrônico de distribuição social móvel totalmente nova, permitindo que cada consumidor se torne um negócio de consumidor.'
        },
      ],
      text0: 'Consumption increases the circulation value of SIE.',
      text1: 'Ecologia da comunidade',
      text1a: 'A ecologia da comunidade é dividida principalmente em comunidade de consumo, comunidade de interesse e comunidade de trabalho.',
      text2: 'Comunidade de consumo',
      text3: 'Comunidade de consume aumenta o valor da circulação de SIE',
      text4: 'Os app tipo consumo acessarão a comunidade Secret. Ao usar uma série de ferramentas, a Secret é usado como método de pagamento para aumentar o valor de circulação de SIE.',
      text5: 'App da comunidade “Super comerciante”',
      text6: 'Os super comerciantes são divididos em comerciantes online e comerciantes offline.',
      text7: 'Comerciantes online: Fornece vários produtos para venda em super comerciantes. Comerciantes offline: através de gerenciar seus clientes da comunidade, oferecem suporte aos clientes para gastar em lojas físicas, pagar com SIE e também podem obter HashRate, participar na emissão de dividendos e receber dividendos do consumo. ',
      text8: 'Comunidade N. ONE',
      text9: 'A comunidade de doces SIE promove a moeda nativa do Secret.',
      text10: 'Comunidade de Caçador de recompensas',
      text11: 'Os comerciantes promovem produtos e distribuem recompensas no sistema de tarefas.',
      text12: 'Comunidade de Ações dos EUA',
      text13: 'A Secret lançará a comunidade de ações dos EUA, que tem as vantagens de negociação flexível T+0, variedades de negociação rica e abertura de conta sem restrição.',
      text14: 'App tipo jogo',
      text15: 'Os produtos atualmente conectados aa Secret incluem: Blockade, jogo Niuniu, Solitário de envelope vermelho e etc.',
      text16: 'Tipo de destruição promove a escassez de SIE',
      text17: 'Os apps destruídos serão conectados à comunidade Secret. Quando os usuários usam WeChat e Alipay como métodos de pagamento, a parte do lucro é SIE destruído, o que promove a escassez de SIE.',
      text18: 'Comunidade de interesses',
      text19: 'Os passatempos dominam a tendência social. A comunidade Secret lança uma rede social de vídeo para fornecer às pessoas uma nova plataforma de namoro, deixando a distância social zero e uma vida mais rica.',
      text20: 'App de comunidade ShowTime',
      text21: 'A comunidade ShowTime é um app social em grande escala estacionado na Secret. ShowTime terá 4 ecossistemas principais: ',
      text22: 'namoro estranho ShowMe, exibição de projetos ShowProject, promoção por transmissão ao vivo ShowLive, e entretenimento de vídeo ShowFun. ',
      text23: 'Comunidade de notícias',
      text24: 'Comunidades de treinamento surgem infinitamente, como manchetes de blockchain em chinês, manchetes de blockchain em coreano, comunidades de aprendizagem de inglês e etc.',
      text25: 'Comunidade de trabalho',
      text25_01: 'A Secret lançará dois apps de trabalho principais para usar a comunidade de maneira eficiente e maximizar os benefícios.',
      text26: 'Comunidade de gerenciamento de tarefas',
      text27: 'Cada projeto tem uma comunidade, como comunidade de desenvolvimento de APP, comunidade de planejamento arquitetônico, comunidade de franquia de loja de chá de leite e etc.',
      text28: 'Comunidade de pasta',
      text29: 'Torna o trabalho mais eficiente, transmissão de arquivos em alta velocidade, download online, armazenamento offline, cada arquivo criptografado para transmissão.',
      text30: 'App SIE',
      text31: 'A Secret se empenhará em construir um sistema de blockchain que possa realmente apoiar o mundo financeiro descentralizado. No mundo DeFi do Secret, o SIE é muito importante, que além de fornece interfaces de pagamento e cobrança para funções de ferramentas e apps ecológicos da comunidade, também servirá como taxas de transação e ativos hipotecários para vários apps do sistema DeFi, e usado como o custo de gas para a execução do contrato inteligente DeFi, o que aumentará muito a frequência de uso do SIE e aumentará o valor do SIE.',
      text32: 'Taxa de função',
      text33: 'Acesso a vários apps funcionais com requisitos de pagamento e fornecer interfaces de cobrança SIE para terceiros.',
      text34: 'Pagamento de loja',
      text35: 'Fornece uma interface de pagamento para app de shopping, permitindo que os usuários pagar diretamente com o SIE, o que é conveniente e rápido.',
      text36: 'Pagamento ecológico de cada comunidade',
      text37: 'Fornece interfaces de pagamento para cada ecologia de comunidade e promove o desenvolvimento saudável da ecologia de comunidade.',
      text38: 'Taxas de transação',
      text39: 'Qualquer taxa de transação e taxa de gas pode ser paga com o SIE, e o HashRate e a dedução do desconto são calculados diretamente sem várias conversões.',
      text40: '',
    },
    banner: {
      text1: 'Poder de explorer segredo',
      text2: 'Toda a comunidade tem seu próprio segredo',
      text3: 'Comunidade，o valor da civilização humana',
      text4: 'Secret，reconstrua a comunidade',
      text5: 'Crenças humanas，segredos da comunidade',
      text6: 'Economia，comunitária, perspectivas mundiais ',
      productSecret: {
        text1: 'Retorne à comunidade e',
        text2: 'detone a',
        text3: ' fonte'
      },
      proCommunity: {
        text1: 'Conecte o',
        text2: ' futuro,',
        text3: 'capacite a alma'
      },
      artificial: { // 技术人工智能
        text1: 'Era da simbiose homem-computador, ',
        text2: 'com conexão infinita'
      },
      tradingCenter: {
        text1: 'Criptografa',
        text2: ' ativos e',
        text3: ' conecta-se à comunidade'
      },
      news: {
        text1: 'Secret,',
        text2: 'novas informações,',
        text3: 'novo mundo'
      },
      about: {
        text1: 'Crie ',
        text2: 'um mundo que inspire',
        text3: 'a conectividade humana'
      },
      help: {
        text1: 'Guia para iniciante,',
        text2: 'obtenha ajuda personalizada'
      },
    },
    newsData2: [
      // 9月
    ...
    newsArr: [
      ...
      {title: 'Anúncio atualizado do Exchange Center', content: ''},
      {title: '27/6/2018 Anúncio de atualização da versão', content: ''},
      {title: '20/6/2018 Anúncio de atualização da versão', content: ''}
    ],
    header: {
      text1: 'Página inicial',
      text2: 'Produto',
      text3: 'App de comunidade',
      text4: 'Tecnologia',
      text5: 'Inteligência artificial',
      text6: '',
      text7: 'Centro de comércio',
      text8: 'Troca',
      text9: 'Centro de notícias',
      text10: 'Perfil',
      text11: 'Ajuda',
      text12: 'Faça o download do papel branco e explore o mundo do Secret',
      text13: 'Comuniadde+link de rede+ Inteligência artificial，o valor combinado das três é muito maior que a soma dos valores individuais de cada tecnologia.<br/>O papel branco do Secret explicará em detalhes como o sistema do Secret mescla os três, produzindo energia incrível como a fusão nuclear.',
      text14: 'Download do papel branco',
      text15: 'Download Secret',
      text16: 'Download',
      text17: 'Secret',
      text18: '关闭',
      text19: 'História mais recente',
      text20: 'Login',
      text21: 'Login com a conta Secret',
      text22: 'Digite o nome do usuário',
      text23: 'Digite a senha',
      text24: 'klein',
      text25: 'Esqueci minha senha？',
      text26: 'Registar',
      text27: 'Corte da língua'
    },
    home: {
      text1: 'Comunidade,',
      text01: 'o valor da civilização humana',
      text2: 'Rede do Secret， Aplicativos da comunidade',
      text3: 'Secret é uma plataforma de aplicativos baseada na comunidade.',
      text03: 'Desenvolvemos uma variedade de aplicativos da comunidade para usuários com base na comunidade, para criar uma ecologia saudável e rica da comunidade.',
      text4: 'Download APP',
      text5: 'Aplicativos típicos, ativar o poder da comunidade',
      text6: 'O Secret desenvolveu e pesquisou muitos aplicativos típicos para a comunidade. Todos os aplicativos são compatíveis entre si e se promovem, e os desenvolvedores terceirizados estão constantemente a adicionar e melhorar vários aplicativos de código aberto para enriquecer a ecologia da comunidade e injetar energia para reiniciar a comunidade.',
      text7: 'Pagamento',
      text8: 'O Secret pode ser usado como uma ferramenta de pagamento nos negócios; Como moeda em circulação, o usuário pode usar diretamente a SIE para realizar as operações  como receber e pagar dinheiro, liquidar taxas de transação, tornando as transações mais convenientes e rápidas.',
      text9: 'Reunião',
      text10: 'O organizador da reunião detém um certo número da SIE e pode provocar uma reunião com uma pessoa completa em um bate-papo em grupo. Se precisar nomear um porta-voz, precisará usar a SIE para recompensar e enviar um envelope vermelho para o grupo.',
      text11: 'Loja',
      text12: 'A loja Secret é dividida em B2C e C2C, o proprietário do grupo pode designar o usuário como vendedor e fazer o upload do produto；Outros usuários usam a SIE para pagamento e liquidação após a compra na loja, e também podem usar bate-papo, avaliação e outras funções.',
      text13: 'Mais aplicações típicas',
      text14: 'Ascensão da comunidade faz do mundo um lugar melhor',
      text15: 'O crescimento dos seres humanos é um processo de conexão com o mundo exterior, que nos ensinou a aproximar mais pessoas.De indivíduos a tribos, de tribos a cidades-estados, de cidades-estados a países, a história prova que a ascensão do poder de comunidade é suficiente para moldar o mundo e mudar o futuro!  ',
      text16: 'No entanto, nos últimos dois séculos, a política social tem sido turbulenta, várias comunidades íntimas estão se desintegrando e comunidades humanas estão entrando em colapso. ',
      text17: 'O Secret deseja reiniciar o poder da comunidade, ativar a economia comunitária, tornar-se uma plataforma comunitária global, reconstruir a conexão entre humanos, promover a profunda evolução da sociedade e permitir que os humanos avancem ainda mais no futuro.',
      text18: 'Secret, enriquece a comunidade e torna o mundo um lugar melhor.',
      text19: 'Criptografia profunda, expansão rápida',
      text20: 'Os dados no sistema são criptografados ponto a ponto e não podem ser adulterados. Os usuários podem se comunicar livremente e trocar informações.Ao mesmo tempo, a arquitetura permite escalabilidade ilimitada a uma velocidade operacional incomparável, com base na link de rede.',
      text21: 'Espírito: Dados do Secret',
      text22: 'Real: Comunidade do Secret',
      text23: 'Digital: Mundo do Secret',
      text24: 'Política de Doces',
      text25: 'O Secret emitirá um certo número de doces de acordo com o preço médio diário no mercado, e contará o poder de computação de usuários baseado na relação de promoção do Secret e o número de usuários em posse, como o peso de cada emissão de doces.',
      text26: 'Saber mais',
      text27: 'Rede do Secret, Ecologia de código aberto',
      text28: 'O Secret é uma plataforma de aplicativos para a comunidade, além de aplicativos básicos, como redes sociais criptografadas, mas também muitos aplicativos típicos. Ao mesmo tempo, combina desenvolvedores de terceiros para criar conjuntamente uma ecologia inteligente para capacitar a comunidade e injetar alma.',
      text29: 'Função principal',
      text30: 'A função principal do Secret é "Segredo"!',
      text31: 'Ecologia inteligente',
      text32: 'A rede do Secret é abrangente, construindo inteligência e criando ecologia.',
      text33: 'Base do Secret',
      text34: 'A comunidade é a base e o valor central do Secret.',
    ...
    tradingCenter: {
      ...
      text2: 'Comece a negociar',
      text3: 'Perfil da SIE',
      text4: 'A SIE é um ativo digital nativo na plataforma do Secret, a base de pagamento para vários aplicativos e uma moeda comum em muitos mundos pequenos do Secret, que podem conectar esses mundos pequenos a um grande mundo.',
      text5: 'Assim como o ouro é um meio de valor que conecta diferentes regiões do mundo, a SIE é uma ponte de valor que conecta diferentes comunidades.',
      text6: 'Meio de valor',
      text7: 'Ponte de comunidade',
      text8: 'Política',
      text9: '1. Política',
      text10: 'O número de emissão de doces é de 10 bilhões e os doces restantes continuarão bloqueados.',
      text11: 'Circulação：O número de emissão de doces é de 10 bilhões e os doces restantes continuarão bloqueados. ',
      text12: 'Valor de poder de computação：O Secret contará o poder de computação de cada usuário com base no consumo do usuário e no consumo da comunidade, e usará isso como o peso da produção de doces.',
      text13: '2.Plano de Doces',
      text14: ' Ativou o modelo de emissão de consumo de doces',
      text15: '(1) De 1 de janeiro de 2020: Ativou o modelo de emissão de consumo de doces',
      text16: 'Ou seja, cada dia que 0.48% é emitido de acordo com a destruição total do consumo e distribuído de acordo com o poder de computação, o poder de computação de consumo e o poder de promoção da computação recebem 0.24%.',
      text16_0: '',
      text16_1: '',
      text16_2: '(2) Regras de distribuição: distribuição de 0.24% de energia de computação de comsumo',
      text16_3: 'a. O usuário consumidor recebe 10 vezes o poder de computação do desconto comercial;',
      text16_4: 'b. O comerciante obtém 2 vezes do poder de computação do que desconto e, ao mesmo tempo, detém a SIE correspondente, se a participação é insuficiente, o poder de computação é calculado de acordo com o valor da participação;',
      text16_5: '(3) Regras de distribuição: distribuição de 0.24% de energia de computação de promoção',
      text16_6: 'c. 0,3 poder do poder de computação acumulado na grande comunidade (usuários consumidores+ comerciantes);',
      text16_7: 'd. 0,7 poder do poder de computação acumulado na pequena comunidade (usuários consumidores+ comerciantes);',
      text16_8: 'e. Para obter o poder da computação das comunidades grande e pequena, precisa ter mais de 100SIE.',
      text16_9: '"Presente secreto de ano novo" para o sistema de doces todo dia de ano novo. O poder de computação gerado por todo o consumo no dia é duplicado aleatoriamente com uma sequência de hash (entre 1,5 e 3 vezes).',
      text16_10: '(4) Presente de Ano Novo Secreto',
      text17: '3. Plano N.ONE',
      text18: 'O dever comercial da fundação do usuário, continua o investimento do recognition mútuo, pode obter o cartão do dever de 50 comerciais, cada semana abre um.',
      text19: '',
      text20: 'A partir de 25 de novembro de 2019, a produção de 50 cartões de tarefas comerciais será de 200%, ou seja, produção de cada cartão será de 4%;',
      text21: 'A partir de 1 de janeiro de 2020, a produção de 50 cartões de tarefas comerciais será de 190%, ou seja, produção de cada cartão será de 3.8%;',
      text22: 'A partir de 1 de fevereiro de 2020, a produção de 50 cartões de tarefas comerciais será de 180%, ou seja, produção de cada cartão será de 3.6%;',
      text23: 'A partir de 1 de abril de 2020, a produção de 50 cartões de tarefas comerciais será de 170%, ou seja, produção de cada cartão será de 3.4%;',
      text23_1: 'A partir de 1 de julho de 2020, a produção de 50 cartões de tarefas comerciais será de 160%, ou seja, produção de cada cartão será de 3.2%;',
      text23_2: 'A partir de 1 de outubro de 2020, a produção de 50 cartões de tarefas comerciais será de 150%, ou seja, produção de cada cartão será de 3%;',
      text23_3: 'A partir de 1 de janeiro de 2021, a produção de 50 cartões de tarefas comerciais será de 140%, ou seja, produção de cada cartão será de 2.8%;',
      text24: '4.特别奖励',
      ...
      text28: 'Manter a ecologia',
      text29: 'Estimular o mercado',
      text30: 'Emissão do consumo',
      text31: 'Gerenciamento digital',
      text32: 'Política de Doces',
      text33: 'A política de doces da SIE também é conhecida como "Plano Super Secret". A emissão da SIE conforme com o consumo diário de usuário no mercado e o consumo da comunidade.',
      text34: 'Criptografa ativos e conecta-se à comunidade',
      text35: 'Criptografa ativos e,',
      text36: ' conecta-se à comunidade',
      text37: '',
      obj: {
        text1: 'A partir de 25 de novembro de 2019, a produção de 50 cartões de tarefas comerciais será de 200%, ou seja, produção de cada cartão será de 4%;',
        text2: 'A partir de 1 de janeiro de 2020, a produção de 50 cartões de tarefas comerciais será de 190%, ou seja, produção de cada cartão será de 3.8%;',
        text3: 'A partir de 1 de fevereiro de 2020, a produção de 50 cartões de tarefas comerciais será de 180%, ou seja, produção de cada cartão será de 3.6%;',
        text4: 'A partir de 1 de abril de 2020, a produção de 50 cartões de tarefas comerciais será de 170%, ou seja, produção de cada cartão será de 3.4%;',
        text5: 'A partir de 1 de julho de 2020, a produção de 50 cartões de tarefas comerciais será de 160%, ou seja, produção de cada cartão será de 3.2%;',
        text6: 'A partir de 1 de outubro de 2020, a produção de 50 cartões de tarefas comerciais será de 150%, ou seja, produção de cada cartão será de 3%;',
        text7: 'A partir de 1 de janeiro de 2021, a produção de 50 cartões de tarefas comerciais será de 140%, ou seja, produção de cada cartão será de 2.8%;',
      }
    },
    about: {
      text1: 'Crie um mundo que inspire a conectividade humana',
      text2: 'Equipe Secret',
      text3: 'Tki Turing AI Technology Co.LTD Holland, sediada na Holanda, foi fundada por um grupo de cientistas e engenheiros apaixonados, com vasta experiência em inteligência artificial e outros campos, cujos membros são principalmente do Google, IBM, Facebook e etc. A missão da Tki Turing é popularizar a inteligência artificial e os robôs de marketing na vida e na socialização das pessoas, criando a melhor experiência. ',
      text4: 'Continuamos a aprimorar nossos produtos para que mais empresas em todo o mundo possam usar a inovação trazida pela alta tecnologia e aproveitar o aplicativo conveniente trazido pela tecnologia.',
      text5: 'Somos um grupo de pessoas que trabalham duro para mudar o futuro e defendemos a inclusão do conceito de liberdade, independência e inteligência em nosso mundo online.',
      text6: 'Começamos com as inovações e tecnologias em que acreditamos e estamos ansiosos por essa evolução global da inteligência que em breve será conhecida pelo público.',
      text7: 'Contatos com nós',
      text8: 'Contatos com nós',
      text9: 'Obrigado pelo seu interesse no Secret.',
      text10: 'Preencha seus comentários ou sugestões no formulário e deixe um endereço de e-mail utilizável, nós responderemos o mais breve possível.',
      text11: 'Nome',
      text12: 'Seu nome',
      text13: 'Apelido',
      text14: 'Seu apelido',
    ...
    help: {
      text1: 'obtenha ajuda personalizada',
      text2: 'Guia para iniciante',
      text3: '1.Registro da conta& Recarga no site oficial',
      text4: '1.Vincule o Google Authenticator ',
      text5: '2.Recomenda: Ferramentas de gerenciamento de ativos',
      text6: '4.Tutorial de consulta de Hash',
      text7: '3.Consulte ativos da SIE',
      text8: 'Clique para ver >',
      text9: 'Tutorial de consulta de Hash',
      text10: 'Ferramentas de gerenciamento de ativos',
      text11: 'Instrumento de activos SIE',
      text12: 'Guia Registro da conta',
      text13: 'Guia Vincule o Google Authenticator',
      text14: '',
      text15: '',
      text16: '',
      text17: '',
    ...
    news: {
      text1: '',
      text2: 'Completamente',
      text3: 'tendência secreta',
      text4: 'Secret，',
      text5: 'novas informações，',
      text6: 'novo mundo',
      text7: 'Examina o cheio - texto',
      text8: 'Retorna o centro da notícia',
      text9: 'MORE',
      text10: '二维码已失效，点击刷新',
    ...
    proSecret: {
      text1: 'Retorne à comunidade，',
      text1a: ' e detone a fonte',
      text2: 'Secret, cria um mundo melhor para você',
      text3: 'O crescimento dos seres humanos é um processo de conexão com o mundo exterior, que nos ensinou a aproximar mais pessoas.De indivíduos a tribos, de tribos a cidades-estados, de cidades-estados a países, a história prova que a ascensão do poder de comunidade é suficiente para moldar o mundo e mudar o futuro!',
      text4: 'Comunidade do Secret, relação social segreda',
      text5: 'No Secret, os usuários podem estabelecer sua própria comunidade Secret. Não há limite superior para o número de pessoas na comunidade, que pode ser de duas ou dez mil pessoas. E essas comunidades estabelecidas no Secret serão protegidas e todas as atividades da comunidade do Secret, bate-papo, compartilhamento e negociação serão realizados em um estado criptografado.',
      text6: 'Confie no Secret e socialize livremente',
      text7: 'Secret anuncia a chegada de um mundo da Internet criptografado socialmente. As informações de usuários não precisam passar pelo servidor, e cada nó da rede possui uma perspectiva e um território exclusivos para toda a rede, permitindo que as informações fluam com mais segurança e liberdade. ',
      text8: 'Download APP',
      text9: 'Criptografia ponto a ponto',
      text10: 'O servidor é responsável por estabelecer o link entre os usuários. Os dados são transmitidos ponto a ponto. Somente os usuários conectados podem descriptografar os dados sem passar pelo servidor.',
      text11: 'Nenhuma análise',
      text12: 'O Secret não pode ler sua mensagem e não compartilhará ou venderá seus dados ou informações de contato com qualquer outro local.',
      text13: 'Código aberto o Secret, participe no Secret',
      text14: 'Como uma plataforma inclusiva, o Secret abrirá a interface para desenvolvedores terceirizados que cumpram os regulamentos da plataforma Secret sob a premissa de manter o Secret, apoiá-los para fornecer uma variedade de aplicativos para a comunidade e os usuários Secret e melhorar ainda mais as funções do Secret para ajudar cultivamos uma rica cultura ecológica do Secret e realizamos a grande visão de que o Secret muda a comunidade e a comunidade muda o mundo.',
      text15: 'Marketing inteligente',
      text16: 'Conecte sua ecologia de marketing ao Secret, vincular clientes com inteligência, reduzindo efetivamente os custos e melhorando a eficiência dos negócios.',
      text17: 'Construir ecologia',
      text18: 'O Secret abre uma interface e espere criar uma ecologia mais inteligente para compartilhar dividendos futuros com todos os parceiros.',
      text19: 'Proteção de segurança',
      text20: 'Criptografia ponto a ponto para proteger todos os dados do usuário, incluindo desenvolvedores de terceiros.',
      text21: 'participe no Secret',
      title1: 'Valor do Secret',
      description1: 'A comunidade muda o mundo, e o Secret muda a comunidade.',
      title2: 'Setor privado',
      description2: 'Nenhum terceiro, incluindo servidores, pode roubar suas mensagens e dados.',
      title3: 'Chat em grupo do Secret',
      description3: 'Adequado para bate-papos em grupo privados e seguros, número ilimitado de pessoas.',
      title4: 'Bate-papo criptografado',
      description4: 'Envie mensagens privadas e seguras aos amigos sem se preocupar em ser supervisionado.',
      title5: 'Transação criptografada',
      description5: 'Gerenciamento de link de rede de transações, mecanismo de rastreabilidade, supervisão de várias links, garantem segurança secreta.',
      title6: 'Compartilhamento criptografado',
      description6: 'Quando é possível definir o compartilhamento de voz, texto, imagem, vídeo, vários dispositivos são excluídos ao mesmo tempo.',
    },
    proCommunity: {
      text1: 'Conecte o futuro,',
      text1a: 'capacite a alma',
      text2: 'Download APP',
      text3: 'Grande visão da Comunidade',
      text4: 'A história provou inúmeras vezes que o progresso social é inseparável da promoção do poder comunitário. A comunidade é a base da estabilidade social e a força motriz para o desenvolvimento futuro.',
      text5: 'Hoje, Secret quer reiniciar o poder comunitário, ativar a economia da comunidade e se tornar uma global plataforma de agrupamento de comunidades, melhorar o relacionamento entre as pessoas, promover a evolução profunda da sociedade, deixando os humanos irem mais longe no futuro. ',
      text6: 'Secret, torne a comunidade mais estreita, torne a comunidade mais forte e torne o ser humano melhor! ',
      text7: 'Reconstrua a comunidade, inspira o futuro',
      text8: 'Estamos numa era de descentralização. A Secret constrói a base ecológica e reconstrói o núcleo da comunidade. Com o objetivo de inspirar os humanos para se conectarem, ele continua a lançar várias funções da comunidade, apps e serviços de produto, e abre uma interface compartilhada para todos os terceiros ao mesmo tempo, permitindo o acesso de desenvolvedores terceirizados.',
      text8_1: 'Quer seja a criação e o lançamento de funções da comunidade ou o acesso e suplementação de apps de terceiros, eles estão melhorando o ecossistema da Secret e permitindo que a comunidade se enriqueça e cresça continuamente. Novos apps são adicionados constantemente e apps antigos são eliminados, sendo uma evolução que tornará a Secret cada vez mais adaptável ao desenvolvimento da sociedade humana, eventualmente reformulando a comunidade moderna e criando uma nova civilização gloriosa! ',
      text9: 'O Secret pode fornecer ferramentas de aplicativos，',
      text9_1: 'para qualquer tipo de comunidade para ajudá-lo a construir uma ecologia da comunidade e desempenhar o valor da comunidade.',
      text10: 'Comunidade，pode ser uma pessoa, uma família, uma cidade-estado, um país ou até um mundo.',
      text11: 'Se quiser, você pode criar qualquer tipo de comunidade no Secret.',
      text12: 'O Secret pode fornecer ferramentas de aplicativos para',
      text13: 'qualquer tipo de comunidade para ajudá-lo a construir uma ecologia da comunidade e desempenhar o valor da comunidade.',
      text14: 'Aplicativos sociais abrangentes',
      text15: 'O Secret é uma plataforma de aplicativos abrangente, além de vários aplicativos desenvolvidos pelo Secret, mas também suporta o acesso de desenvolvedores de terceiros à plataforma, injetando energia e capacitando a comunidade.',
      text16: 'Download APP',
      rightList: [
        {
          imgUrl: require('../../assets/img/community/rightListImg/1.svg'),
          title: 'Reunição',
          description: 'O organizador da reunião detém um certo número da SIE e pode provocar uma reunião com uma pessoa completa em um bate-papo em grupo. Se precisar nomear um porta-voz, precisará usar a SIE para recompensar e enviar um envelope vermelho para o grupo.'
        },
        {
          imgUrl: require('../../assets/img/community/rightListImg/2.svg'),
          title: 'Transação',
          description: 'As transações são divididas em transações OTC e transações correspondentes. Os membros do grupo podem realizar diretamente qualquer transação P2P de qualquer ativo digital do grupo, ou seja, transação OTC, a SIE paga a taxa de proccessamento. Também podem usar o modo de transação correspondente, ou seja, o proprietário do grupo estabelece uma plataforma de transação online.'
        },
        {
          imgUrl: require('../../assets/img/community/rightListImg/3.svg'),
          title: 'Mesa de trabalho',
          description: 'A equipe do projeto pode gerenciar o cronograma do projeto e organizar tarefas de trabalho. As funções avançadas exigem que os usuários mantenham uma certa quantidade de SIE ou paguem SIE para desbloquear e usar.'
        },
        {
          imgUrl: require('../../assets/img/community/rightListImg/4.svg'),
          title: 'Chatbot',
          description: 'Os usuários podem usar chatbots com um certo número de SIE, ou fazer compras com SIE, para personalizar métodos de treinamento e torná-lo seu próprio assistente de chat. Independentemente do número de usuários em um grupo, os chatbots inteligentes podem lidar facilmente.'
        },
        {
          imgUrl: require('../../assets/img/community/rightListImg/5.svg'),
          title: 'Mais',
          description: 'Além dos aplicativos típicos da plataforma Secret, existem muitos aplicativos de código aberto, e desenvolvedores de terceiros continuarão a adicionar e aprimorar aplicativos ecológicos. Mais importante, todos esses aplicativos não são isolados, mas compatíveis entre si e se promovem.'
        }
      ],
      text17: 'Secret,capacite a comunidade',
      text17_1: 'compartilhe a economia，e abra uma nova era dos tempos!',
      text17_2: 'e abra uma nova era dos tempos!',
      leftList: [
        { // 1
          imgUrl: require('../../assets/img/communityToolkit/community_01.svg'),
          title: 'Conversa criptografada',
          description: 'Ao usar o Secret, todas as informações do usuário, incluindo login e chamada, serão criptografadas automaticamente de ponta a ponta para garantir segurança e privacidade de todas as informações de convsersa.  '
        },
        {// 2
          imgUrl: require('../../assets/img/communityToolkit/community_02.svg'),
          title: 'Comunidade ',
          description: 'Este é um círculo de amigos da comunidade. Os usuários podem postar conteúdo e compartilhar suas próprias experiências de vida.'
        },
        {// 3
          imgUrl: require('../../assets/img/communityToolkit/community_03.svg'),
          title: 'Comunidade de dez mil pessoas',
          description: 'Os usuários podem criar sua própria comunidade de dez mil pessoas para conversar, socializar e compartilhar arquivos com várias funções da comunidade.'
        },
        {// 4
          imgUrl: require('../../assets/img/communityToolkit/community_04.svg'),
          title: 'Reunião de voz e vídeo ',
          description: 'A Secret suportará a software de videoconferência em nuvem de celular com várias pessoas, fornecendo aos usuários chamadas de voz e vídeo de alta definição de várias pessoas, compartilhamento de tela, gerenciamento de reserva de reunião e outros serviços de comunicação empresarial nos terminal celular e PC.'
        },
        {// 5
          imgUrl: require('../../assets/img/communityToolkit/community_05.svg'),
          title: 'Rádio ',
          description: 'A Secret suportará rádios na comunidade, permitindo aos usuários compartilhar mais trabalhos de áudio de alta qualidade e obter recompensas.'
        },
        {// 6
          imgUrl: require('../../assets/img/communityToolkit/community_06.svg'),
          title: 'Manchetes ',
          description: 'Publica manchetes sobre a comunidade na comunidade e compartilha-as com usuários de outros produtos nãa Secret nem pertencentes à comunidade.'
        },
        {// 7
          imgUrl: require('../../assets/img/communityToolkit/community_07.svg'),
          title: 'Transmissão ao vivo ',
          description: 'A Secret suportará à transmissão ao vivo da comunidade e os usuários da comunidade poderão assistir à transmissão ao vivo. '
        },
      ],
      text18: '2.Comercial',
      text19: '3.Gerencionamento',
      text20: '4.Tecnologia',
      text21: 'Visão de valor antes do tempo',
      text22: 'Com o advento da era das finanças descentralizadas, a tecnologia de design de blockchain da Secret será ainda mais fortalecida. Além de aumentar significativamente a frequência das transações de blockchain, um sistema de contrato inteligente original também será adotado para oferecer suporte a um sistema de contrato inteligente mais complexo no futuro.',
      text23: 'O sistema de blockchain DeFi criado pela Secret tem uma frequência de liquidação semelhante à do VISA, e fornece um grande número de interfaces de computação de contrato e se combina com o ecossistema Secret, para que todos possam ingressar no mundo financeiro descentralizado de DeFi.',
      text24: 'O processo de descoberta de valor é infinito. Seja construindo um ecossistema único ou construindo um blockchain DeFi, é uma grande tentativa da Secret na onda de mudança dos tempos. Somente tentando constantemente podemos inspirar verdadeiramente o futuro, dar as boas-vindas ao futuro, abraçar o futuro, criar valor máximo e tornar a humanidade melhor!',
      text25: 'Secret，reconstruir a comunidade, construir a ecologia e criar uma nova era de finanças!',
      text26: '1.Relação social',
      text27: 'A caixa de ferramentas inclui quatro categorias: relação social, comercial, gerenciamento e tecnologia.',
      text28: 'Caixa de ferramentas',
      text29: '',
      text30: '',
      text31: 'Reconstrua a comunidade, inspira o futuro',
      ...
      text34: 'Ecossistema com tudo incluído',
      text35: 'Com base na infraestrutura ecológica existente, as várias funções e apps fornecidos pela Secret podem servir a todos os usuários em um modo de comunidade e também podem ajudá-los a criar seu próprio valor!',
      list2: [
        {
          imgUrl: require('../../assets/img/communityToolkit/business_01.svg'),
          title: 'Comerciantes online e offline',
          description: 'Atualmente, muitos comerciantes estão estacionados no Secret. O consumo com SIE nos comerciantes pode obter HashRate, participar na emissão de dividendos e receber dividendos do consumo. Pode ver os endereços de comerciantes offline quando abre o mapa Secret, e pode ver vários produtos vendidos por comerciantes online nos apps de plataforma aberta. '
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_02.svg'),
          title: 'Processo de exibição e vendas de produtos',
          description: 'Os comerciantes fazem upload de produtos de alta qualidade e monitoram todo o processo de vendas de produtos em tempo hábil por meio de funções poderosas de gerenciamento back-end, aplicável nos modelos de negócios B2C e C2C. '
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_03.svg'),
          title: 'Função de pagamento ',
          description: 'Os usuários podem pagar por vários produtos offline com o Secret.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_04.svg'),
          title: 'OTC over-the-counter trading ',
          description: 'Os usuários podem comprar vários tipos de ativos virtuais por app OTC, e as transações comerciais em tempo real podem ser realizadas por meio de confirmação por ambas as partes.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_05.svg'),
          title: 'Carteira',
          description: 'Os usuários podem adicionar várias moedas convencionais no app de carteira, como BTC, ETH, USDT e etc., e também pode retirar moedas para qualquer bolsa e carteira. Ao mesmo tempo, a plataforma aberta oferece suporte a terceiros para acessar sua própria moeda virtual e criar suas próprias carteiras. '
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_06.svg'),
          title: 'Câmbio monetário',
          description: 'Os usuários podem usar qualquer ativo virtual para trocar ativos na janela de conversa criptografada, e a troca pode ser bem-sucedida, desde que todos concordem com o valor.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_07.svg'),
          title: 'Envelope vermelho',
          description: 'O envelope vermelho pode escolher a função de posicionamento, e só pode obter o envelope vermelho no local designado. Também pode ativar a função AR, ou seja, precisa encontrar e digitalizar o item AR especificado para recebê-lo com sucesso. Também pode ser definido como um envelope vermelho de imagem, ou seja, o usuário precisa encontrar a imagem especificada para abrir o envelope vermelho.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/business_08.svg'),
          title: 'Plataforma de negociação de moeda digital',
          description: 'A plataforma de negociação de moeda digital da Secret possui transações de ativos monetários nas principais moedas, como BTC, ETH, USDT e SIE. '
        },
      ],
      list3: [
        {
          imgUrl: require('../../assets/img/communityToolkit/3_01.svg'),
          title: 'Relação entre comunidades',
          description: 'Qualquer app de terceiro pode oferecer recompensas e descontos através de convidar usuários para a comunidade. '
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/3_02.svg'),
          title: 'Gestão de relacionamento social',
          description: 'Os usuários gerenciam os relacionamentos sociais principais através do Secret.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/3_03.svg'),
          title: 'Sistema de gerenciamento de tarefas Task',
          description: 'Secret lançará uma plataforma de gerenciamento de tarefas para ajudar todas as equipes e indivíduos a se concentrarem em seus objetivos, projetos e tarefas, gerenciar e visualizar tarefas a qualquer tempo, em qualquer lugar.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/3_04.svg'),
          title: 'Sistema de teletrabalho',
          description: 'A Secret estabelece uma plataforma de gerenciamento colaborativo empresarial abrangente e integrada, abrangendo apps como documentos online, check-in remoto, reunião de voz e vídeo, gerenciamento de projetos, gerenciamento de tarefas e gerenciamento de cronograma.'
        },
      ...
      list4: [
        {
          ...
          title: 'Conversa agente',
          description: 'Os usuários podem configurar o robô agente que pode se comunicar com seus amigos através de treinamento contínuo.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/4_02.svg'),
          title: 'Robô inteligente de atendimento ao cliente',
          description: 'Os usuários podem se conectar à interface Api de plataforma aberta, e deixar o robô se tornar seu serviço ao cliente para responder a todas as perguntas de usuários.'
        },
        {
          imgUrl: require('../../assets/img/communityToolkit/4_03.svg'),
          title: 'Fábrica de robôs',
          description: 'Os usuários podem configurar robôs AI específicos da comunidade e personalizá-los para a comunidade, servindo aos usuários da comunidade.'
        },
      ],
    },
    tecIntel: {
      text1: 'Era da simbiose homem-computador，',
      text1a: ' com conexão infinita',
      text2: 'Download APP',
      text3: 'Integração da mais recente tecnologia de AI',
      text4: 'O futuro da AI aberta é mais do que isso',
      text5: 'O futuro da AI aberta é mais do que isso',
      text6: 'Copie dados, continue com a alma',
      text7: 'Use a tecnologia da link de rede para armazenar e executar dados humanos para criar outro você.',
      text8: 'Download APP',
      text9: 'Combinação cérebro-computador transforma a consciência',
      text10: 'O cérebro humano está conectado ao mundo digital, e os comandos gerados pelo córtex cerebral serão transferidos para o mundo digital, e os sinais digitais os transferirão para máquinas e sistemas automatizados.',
      text11: 'Ainda somos uma criança em frente do universo, agora, construímos uma grande causa juntos',
      text12: 'Junte-se a nós',
      listTwo: [
        {
          img: require('../../assets/img/ai/li-a.jpg'),
          icon: require('../../assets/img/ai/bule-icon.svg'),
          tit: 'Copie dados, continue com a alma',
          text: 'Use a tecnologia da link de rede para armazenar e executar dados humanos para criar outro você.',
        },
        {
          img: require('../../assets/img/ai/li-b.jpg'),
          icon: require('../../assets/img/ai/red-icon.svg'),
          tit: 'Combinação cérebro-computador transforma a consciência',
          text: 'O cérebro humano está conectado ao mundo digital, e os comandos gerados pelo córtex cerebral serão transferidos para o mundo digital, e os sinais digitais os transferirão para máquinas e sistemas automatizados.',
        }
      ],
      aiTechnique: [
        {
          tit: 'Aprendizado profundo de algoritmo',
          img: require('../../assets/img/ai/li-1.svg'),
          text: 'O diálogo do robô é mais inteligente e antropomórfico',
        },
        {
          tit: 'Processamento de linguagem natural',
          img: require('../../assets/img/ai/li-2.svg'),
          text: 'Várias rodadas de conversas inteligentes, compreensão contextual',
        },
        {
          tit: 'Tecnologia de big data',
          img: require('../../assets/img/ai/li-3.svg'),
          text: 'Aplicativos de big data em cenários de diálogo do setor',
        },
        {
          tit: 'Tecnologia de interação homem-computador',
          img: require('../../assets/img/ai/li-4.svg'),
          text: 'A interação inteligente homem-computador traz infinitas possibilidades para relação social',
        },
        {
          tit: 'Aprendizagem por reforço profundo',
          img: require('../../assets/img/ai/li-5.svg'),
          text: 'Tecnologia de aprendizagem profunda e rede neural para resolver mais problemas',
        },
        {
          tit: 'Reconhecimento de texto',
          img: require('../../assets/img/ai/li-6.svg'),
          text: 'Tecnologia de reconhecimento de texto para detecção de área em cenas naturais',
        }
      ],
    },
    tecBlock: {
